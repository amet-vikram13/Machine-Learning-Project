...
#initial_episodes = 150000
initial_episodes = 200000
#initial_episodes = 225000
#initial_episodes = 1000000 
...
def generate_training_data() :
	...
	np.save('task1_training_data/training_data.npy',training_data_save)
...
#training_data = np.load("task1_training_data/training_data_6125.npy")
...
def neural_network_model(input_shape) :
	...
	hidden_layer = Dense(1024,activation="tanh")(hidden_layer)
	hidden_layer = Dropout(0.4)(hidden_layer)
	hidden_layer = Dense(2048,activation="tanh")(hidden_layer)
	hidden_layer = Dropout(0.4)(hidden_layer)
	hidden_layer = Dense(4096,activation="tanh")(hidden_layer)
	hidden_layer = Dropout(0.4)(hidden_layer)
	hidden_layer = Dense(2048,activation="tanh")(hidden_layer)
	hidden_layer = Dropout(0.4)(hidden_layer)
	hidden_layer = Dense(1024,activation="tanh")(hidden_layer)
	hidden_layer = Dropout(0.4)(hidden_layer)
	hidden_layer = Dense(512,activation="tanh")(hidden_layer)
	#hidden_layer = Dropout(0.8)(hidden_layer)
	hidden_layer = Dense(256,activation="tanh")(hidden_layer)
	hidden_layer = Dense(128,activation="tanh")(hidden_layer)
...
def train_data(training_data):
	...
	print(model.summary())
	model.fit(x=inputs,y=outputs,batch_size=128,epochs=20,verbose=1)
	return model

#model = train_data(training_data)
#model.save("models/task1_model_5.h5")
#print("model trained!")

model = load_model("models/final_task1_model_5.h5")
